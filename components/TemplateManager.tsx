...
export function TemplateManager({
  ...
  return (
    <Card className="bg-input/30 border-dashed border-border-muted mb-0" >
      <CardHeader>
      ...
      <CardContent className="grid grid-cols-2 gap-2">
        <Button
          variant="outline"
          className="text-xs bg-input py-2 border border-border-muted rounded-lg font-medium hover:border-primary text-slate-400 hover:text-primary transition-colors"
